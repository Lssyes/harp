...
class GlobalConfig:
    ...
    def __init__(self):
        ...
        # added for harp
        self.enable_H1F1B = False
        self.enable_ZRP = False    
        self.enable_Hetero = False
        self.layer_construction_eps = 0.5
        self.NCCL_MAX_CTAS_CROSS_RESHARDING = -1
        self.profile_memory_safe_level = [0]
        self.intra_cluster_network_performance = None
        self.inter_cluster_network_performance = None
        self.communication_scale = 1.0
        self.enable_intra_ib = []
        self.enable_inter_ib = []
        self.exp_name = "exp-default"
